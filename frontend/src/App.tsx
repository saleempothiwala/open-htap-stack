  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-64 z-40 bg-[#121820]/80 backdrop-blur-xl shadow-[4px_0_24px_rgba(0,0,0,0.5)] flex flex-col pt-24 pb-8 px-4">
      ...
      <div className="mt-auto pt-6 space-y-1 border-t border-white/5">
        <button className="w-full mb-6 py-3 bg-[#99f7ff] text-[#005f64] font-headline font-bold text-[0.6875rem] tracking-[0.15em] hover:brightness-110 active:scale-95 transition-all cursor-pointer">
          DEPLOY ASSET
        </button>
        <a className="flex items-center gap-4 px-4 py-2 text-slate-500 opacity-70 hover:opacity-100 transition-all duration-300" href="#">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          <button className="p-2 text-slate-400 hover:text-white hover:bg-white/5 transition-colors cursor-pointer active:scale-95 duration-200 relative">
            ...
            <span className="absolute top-2 right-2 w-1.5 h-1.5 bg-[#ff7162] rounded-full"></span>
          </button>
  ...
  return (
    <div className="fixed bottom-8 right-8 z-50 flex items-center gap-4 bg-[#20262f] p-4 rounded-xl border border-[#99f7ff]/20 shadow-2xl backdrop-blur-md">
      ...
      <div className="w-12 h-12 bg-[#151a21] rounded-lg flex items-center justify-center relative">
        ...
        <span className="absolute -top-1 -right-1 w-3 h-3 bg-[#99f7ff] rounded-full border-2 border-[#20262f] animate-pulse"></span>
      </div>
    </div>
  )
}
